...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6a74fd25c1b5db006b5c7fd27f237682) *)
(*
...
let setup_t =
  {
       ...
       [
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$parser_test", []))];
          ...
          ("constructor_test",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$constructor_test", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("qualifier_test",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$qualifier_test", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "parser_test"
                        ]
                   });
               Executable
                 ({
                     cs_name = "constructor_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ExternalTool "ocamlbuild";
                           InternalExecutable "constructor_test"
                        ]
                   });
               Executable
                 ({
                     cs_name = "qualifier_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ExternalTool "ocamlbuild";
                           InternalExecutable "qualifier_test"
                        ]
                   })
            ];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "#\001=\003\159\158\029>\203\024=\131)\160\188g";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
