...
(* OASIS_START *)
(* DO NOT EDIT (digest: 11c9c0b298e33749d963c0f7f9e4e9f9) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ppx_bitstring.ml"});
               Executable
                 ({
                     cs_name = "parser_test";
                     cs_data = PropList.Data.create ();
                      ...
                      bs_byteopt =
                        [
                           (OASISExpr.EBool true,
                             ["-ppx"; "../_build/src/ppx_bitstring.native"])
                        ];
                      bs_nativeopt =
                        [
                           (OASISExpr.EBool true,
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\187\215\208:-Xs\150\207\160M\233\182\248\004o";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
