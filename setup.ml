...
(* OASIS_START *)
(* DO NOT EDIT (digest: fa45c6b9f0276ccfeab5249196295244) *)
(*
...
let setup_t =
  {
     ...
     build =
       OCamlbuildPlugin.build
         [
            "-use-ocamlfind";
            "-plugin-tags";
            "'package(ppx_driver.ocamlbuild), package(js-build-tools.ocamlbuild_goodies)'"
         ];
     test =
       [
          ("ppx_bitstring_constructor_test",
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Xavier Gu\195\169rin"];
          homepage = Some "https://github.com/xguerin/ppx_bitstring";
          ...
          sections =
            [
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/xguerin/ppx_bitstring.git";
               ...
               Executable
                 ({
                     cs_name = "ppx_bitstring_constructor_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "BitstringConstructorTest.ml"
                   });
               Test
                 ({
                     cs_name = "ppx_bitstring_constructor_test";
               ...
               Executable
                 ({
                     cs_name = "ppx_bitstring_parser_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "BitstringParserTest.ml"
                   });
               Test
                 ({
                     cs_name = "ppx_bitstring_parser_test";
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ExternalTool "ocamlbuild";
                           InternalExecutable "ppx_bitstring_parser_test"
                        ]
                   });
               Executable
                 ({
                     cs_name = "ppx_bitstring_qualifier_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "BitstringQualifierTest.ml"
                   });
               Test
                 ({
                     cs_name = "ppx_bitstring_qualifier_test";
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ExternalTool "ocamlbuild";
                           InternalExecutable "ppx_bitstring_qualifier_test"
                        ]
                   })
            ];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "j\138\188k\136\029O\209\208\212R\015h\192\152M";
     oasis_exec = None;
